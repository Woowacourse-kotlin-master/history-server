...
public class SocialLoginServiceImpl implements SocialLoginService {
    ...
    public LoginToken loginWithToken(SocialProvider provider, SocialTokenRequest tokenRequest) {
        ...
        if (!isValidToken) {
            throw new HistoryException(ErrorCode.INVALID_PARAMETER, "유효하지 않은 토큰입니다");
        }
    ...
    private OAuth2Service getOAuth2Service(SocialProvider provider) {
        ...
        if (service == null) {
            ...
            throw new HistoryException(ErrorCode.INVALID_PARAMETER);
        }
    ...
    private Member createSocialUser(SocialProvider provider,
        ...
        if (user == null) {
            ...
            if (existingUserByEmail.isPresent()) {
                ...
                throw new HistoryException(ErrorCode.DUPLICATE_EMAIL);
            }
            ...
            user.updateEmail(userResponse.getEmail());
